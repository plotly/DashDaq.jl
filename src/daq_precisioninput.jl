...
function daq_precisioninput(; kwargs...)
        available_props = Symbol[:id, :className, :disabled, :label, :labelPosition, :max, :min, :persisted_props, :persistence, :persistence_type, :precision, :size, :style, :theme, :value]
        wild_props = Symbol[]
        return Component("daq_precisioninput", "PrecisionInput", "dash_daq", available_props, wild_props; kwargs...)
end
